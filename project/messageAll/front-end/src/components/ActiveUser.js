        ...
        return (
            <div style={{marginBottom:"0.25em", position:"relative", height:"100%"}}>
                ...
                <div style={{ display: "inline-block", height:"100%"}}>
                    <p style={{ height: "100%", marginTop: "0em", position: "absolute", top: '20%', marginBlockStart: "0px", marginBlockEnd: "0px", verticalAlign:"base", display:'inline', padding:'2.5%'}}>
                        {this.state.user.userName}
                    </p>
                    <div style={{ width: "1em", height: "1em" , background:"green", borderRadius:"50%", position:"absolute", right:"1em", bottom:"50%" }}></div>
                </div>
            </div>
        )
    }
